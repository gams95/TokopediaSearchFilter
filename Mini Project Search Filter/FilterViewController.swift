...
class FilterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        switchWholesale.addTarget(self, action: #selector(wholesaleStateChanged(switchState:)), for: UIControlEvents.valueChanged)
        switchGold.addTarget(self, action: #selector(GoldStateChange(switchState:)), for: UIControlEvents.valueChanged)
        switchOfficial.addTarget(self, action: #selector(officialStateChange(switchState:)), for: UIControlEvents.valueChanged)
